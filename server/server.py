...
# I've not used Python before so I had to do a bit of learning and research
# before designing this solution. Using vanilla python to create endpoints looked
# quite challenging and so I opted to use Flask and Cors as it seemed to make 
# the process a little easier. The syntax is quite similar to Node.js and Express
# which I am more familiar with. I also used the Flask documentation to help me.
